...
import { Brain, Loader2, AlertTriangle, ArrowRight, Eye, EyeOff } from "lucide-react";
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-12">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-96 w-96 rounded-full bg-indigo-600/5 blur-[100px]" />
      ...
      <div className="relative w-full max-w-[400px] animate-slide-up">
        ...
        <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-8 shadow-2xl shadow-black/40 backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {error && (
              <Alert className="border-red-500/20 bg-red-500/8 text-red-400">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-[11px] text-muted-foreground transition-colors hover:text-violet-400"
                >
                  Forgot password?
                </Link>
              </div>
